  ...
  const services = [
    {
      ...
      description:
        "Custom-built homes designed with care, quality, and Austin's unique character in mind.",
      image:
    ...
    },
    {
      ...
      description:
        "Professional office buildings and retail spaces designed for business success and growth.",
      image:
    ...
    },
    {
      ...
      description:
        "Transform existing spaces with expert renovation services that breathe new life into your property.",
      image:
    ...
    //   description:
    //     "Large-scale infrastructure projects including roads, bridges, and public facilities built to last.",
    //   image:
    ...
    //   description:
    //     "Comprehensive safety assessments and consulting services for all construction projects.",
    //   image:
    ...
    //   description:
    //     "24/7 emergency construction and repair services when you need immediate professional assistance.",
    //   image:
    //     "https://images.pexels.com/photos/834892/pexels-photo-834892.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&fit=crop",
    // },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            building needs, from residential projects to large-scale commercial
            developments.
          </p>
        </div>
